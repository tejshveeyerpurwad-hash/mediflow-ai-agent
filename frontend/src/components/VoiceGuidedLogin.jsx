...
const LOGIN_PROMPTS = {
  en: {
    welcome: 'Welcome to MediFlow AI. For login, please say your registered mobile number.',
    ...
    complete: 'You are now logged in. Welcome to MediFlow AI.',
  ...
  hi: {
    welcome: 'MediFlow AI mein aapka swagat hai. Login ke liye apna mobile number boliye.',
    ...
    complete: 'Aap login ho gaye hain. MediFlow AI mein aapka swagat hai.',
  ...
  mr: {
    welcome: 'MediFlow AI madhye aaple swagat aahe. Login sathi aapla mobile number bolaa.',
    ...
    complete: 'Aap login zale aahat. MediFlow AI madhye aaple swagat aahe.',
  ...
  ta: {
    welcome: 'MediFlow AI-ku varavekkam. Login-ukaga ungal mobile ennai solungal.',
    ...
    complete: 'Neengal login agiviteergal. MediFlow AI-ku varavekkam.',
  ...
  te: {
    welcome: 'MediFlow AI lo miku svagatham. Login kosam mi mobile number cheppandi.',
    ...
    complete: 'Mee login ayipoyaru. MediFlow AI ku svagatham.',
  ...
  bn: {
    welcome: 'MediFlow AI-e apnake shagotom. Login-er jonno apnar mobile number bolun.',
    ...
    complete: 'Apni login korechen. MediFlow AI-e shagotom.',
  ...
  gu: {
    welcome: 'MediFlow AI ma tamaru svagat che. Login mate tamaro mobile number bolo.',
    ...
    complete: 'Tamaru login thai gayu. MediFlow AI ma tamaru svagat che.',
